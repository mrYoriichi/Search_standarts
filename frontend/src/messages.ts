...
const cs = {
  ...
  'lib.pagesTotal': 'Stránek v indexu celkem: {n}',
  'lib.scanDuplicates':
  ...
  'arch.summaryAdopted': ', převzato {n} hotových indexů (zdarma)',
...
const en: Record<MsgKey, string> = {
  ...
  'lib.pagesTotal': 'Total pages in the index: {n}',
  'lib.scanDuplicates':
  ...
  'arch.summaryAdopted': ', adopted {n} ready-made indexes (free)',
...
const de: Record<MsgKey, string> = {
  ...
  'lib.pagesTotal': 'Seiten im Index insgesamt: {n}',
  'lib.scanDuplicates':
  ...
  'arch.summaryAdopted': ', {n} fertige Indexe übernommen (kostenlos)',
